...
namespace ConsoleApp.Data.EfCore
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<Customers2> Customers2 { get; set; }
        public virtual DbSet<EmployeePerformans> EmployeePerformans { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseMySql("server=127.0.0.1;port=3306;database=northwind;user=root;password=145322", x => x.ServerVersion("8.0.21-mysql"));
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmployeePerformans>(entity =>
            {
                entity.HasKey(e => e.EmployeeId)
                    .HasName("PRIMARY");

                entity.ToTable("employee_performans");
                ...
                entity.Property(e => e.SatisAdeti).HasColumnName("satis_adeti");
            });
